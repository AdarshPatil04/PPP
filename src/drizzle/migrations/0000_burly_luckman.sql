...
CREATE TABLE "country_groups_discounts" (
	...
	CONSTRAINT "country_groups_discounts_country_group_id_product_id_pk" PRIMARY KEY("country_group_id","product_id")
);
...
--> statement-breakpoint
ALTER TABLE "country_groups_discounts" ADD CONSTRAINT "country_groups_discounts_country_group_id_country_groups_id_fk" FOREIGN KEY ("country_group_id") REFERENCES "public"."country_groups"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "country_groups_discounts" ADD CONSTRAINT "country_groups_discounts_product_id_products_id_fk" FOREIGN KEY ("product_id") REFERENCES "public"."products"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
