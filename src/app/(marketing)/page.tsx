    ...
    <>
      <section className="min-h-screen bg-[radial-gradient(hsl(0,72%,65%,40%),hsl(24,62%,73%,40%),hsl(var(--background))_60%)] flex items-center justify-center text-center text-balance flex-col gap-8 px-4">
        ...
        <p className="text-lg lg:text-3xl max-w-screen-xl">
          ...
          Capture 85% fo the untapped market with location-based dynamic pricing
        </p>
        <SignUpButton>
          ...
          <div className="flex flex-col gap-8">
            ...
            <FooterLinkGroup
              ...
              links={[
                ...
                { label: "SaaS Business", href: "#1" },
                { label: "Online Courses", href: "#2" },
              ]}
            />
          </div>
          <div className="flex flex-col gap-8">
            ...
            <FooterLinkGroup
              ...
              links={[
                ...
                { label: "Coupon Generator", href: "#1" },
                { label: "Stripe App", href: "#2" },
              ]}
            />
            <FooterLinkGroup
              title="Company"
              links={[
                { label: "Affilate", href: "#" },
                { label: "Twitter", href: "#1" },
                { label: "Terms of Service", href: "#2" },
              ]}
            />
          </div>
          <div className="flex flex-col gap-8">
            <FooterLinkGroup
              ...
              links={[
                ...
                { label: "Gumroad", href: "#1" },
                { label: "Stripe", href: "#2" },
                { label: "Chargebee", href: "#3" },
                { label: "Paddle", href: "#4" },
              ]}
            />
            <FooterLinkGroup
              ...
              links={[
                ...
                { label: "Lemon Squeezy", href: "#1" },
                { label: "Gumroad", href: "#2" },
                { label: "Stripe", href: "#3" },
                { label: "Chargebee", href: "#4" },
                { label: "Paddle", href: "#5" },
              ]}
            />
          </div>
